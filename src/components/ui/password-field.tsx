import React, { forwardRef, useState, type ChangeEvent } from 'react';
  ...
  return (
    ...
    >
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
        d="M3.98 8.223A10.477 10.477 0 0 0 1.934 12C3.226 16.338 7.244 19.5 12 19.5c.993 0 1.953-.138 2.863-.395M6.228 6.228A10.45 10.45 0 0 1 12 4.5c4.756 0 8.774 3.162 10.066 7.5a10.522 10.522 0 0 1-4.293 5.143M6.228 6.228 3 3m3.228 3.228 12.544 12.544"
      />
      <path
        strokeLinecap="round"
        strokeLinejoin="round"
...
function PasswordField(
  ...
  return (
    <div className="relative w-full text-white font-sans text-sm font-semibold leading-8 mb-8">
      ...
      <span
        className="absolute top-12 right-4 cursor-pointer text-white"
      ...
      {error && (
        <span className="absolute left-0 bottom text-xs text-[#FB2C36] mt-1 block">
          {error}
        </span>
      )}
    </div>
