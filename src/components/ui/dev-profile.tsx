      ...
      <div className="space-y-8">
        ...
        <div className="flex justify-start items-center gap-10">
          ...
          <Button
            variant="primary"
            size="primary"
            className="w-full hover:bg-[#8A2BE2] transition-colors py-2"
            onClick={viewProfile}
          >
            View Profile
          </Button>
