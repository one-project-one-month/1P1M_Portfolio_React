...
// const ProjectCard = ({title, img, description, submittedByProfile, likestate, likecount, postBy, tag, status = null}) =>{
const ProjectCard = ({title = "ERP Management System", submittedByProfile = "https://images.pexels.com/photos/1036627/pexels-photo-1036627.jpeg", description = "Integrating business processes into one system. Helps manage sales, inventory, and accounting efficiently.", likestate, likecount = 565, postBy = "Kyaw Thura", tag=[1,2], status = 2}) =>{
            ...
            <div className="h-full flex flex-col gap-[14px] items-center">
                ...
                <div className="flex justify-center items-center gap-2">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="w-[32px] h-[32px] rounded-full bg-gray-300 overflow-hidden">
                            <img src={submittedByProfile} className="object-cover" alt="user" />
                        </div>
                        <p>{postBy}</p>
                    </div>
                </div>
