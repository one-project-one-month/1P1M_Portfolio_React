        ...
        <div className="w-full h-screen absolute left-0 top-0 flex justify-center items-center bg-slate-950/20 z-99">
          <div className="w-[410px] border border-[#99A1AF] bg-black rounded-3xl space-y-5 px-16 py-8">
            ...
            <p className="text-[#99A1AF] ">
              The project idea will be rejected. Are you really want to reject
              it?
            </p>
            <div className="flex justify-center items-center gap-8">
              <Button
                variant="black_button"
                size="primary"
                className="bg-black border-[#6A7282] text-[#99A1AF] px-8"
                onClick={() => onRejectClick(null)}
              >
                Cancel
              </Button>
              <Button
                variant="primary"
                size="primary"
                className="relative bg-[#C10007]/70 hover:bg-[#C10007]/100 px-8"
                onClick={() => {
                  onReject && onReject(projectId);
                }}
              >
                <div className="absolute left-3">
                  {rejectLoading && (
