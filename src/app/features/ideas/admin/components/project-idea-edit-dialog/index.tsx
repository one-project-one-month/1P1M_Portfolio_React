...
import { editProjectIdea } from '../../../shared/services/project-idea.service';
import {
  editIdeaSchema,
  type EditIdeaType,
  type IdeaEditFormPropsType,
  type IdeaEditResponseType,
  type Step,
...
export default function ProjectIdeaEditDialog({
  ...
  const handleFinalSubmit = (formData: Partial<EditIdeaType>) => {
