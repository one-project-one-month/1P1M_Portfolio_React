...
import AddMemberModal from '../../../portfolio-management/components/add-member-modal';
import TeamForm from '../../../portfolio-management/components/team-create-form';
    ...
    <div className="space-y-6 text-white">
      ...
      {!isReadOnly && (
        <div className="flex gap-3 relative mt-2">
          <Button
            className="w-full bg-[#9C39FC] hover:bg-[#9333ea] text-lg font-medium rounded-lg px-3 py-1.5 text-[#F9FAFB] gap-1 relative"
