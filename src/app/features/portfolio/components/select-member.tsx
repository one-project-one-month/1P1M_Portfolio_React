    ...
    <div className="z-0 mb-2 -mt-4 flex flex-col">
      <div className="flex items-center gap-2">
        ...
        <div className="flex -space-x-2">
          {selectedMembers.slice(0, MAX_VISIBLE_AVATARS).map((member, index) => (
            <img
        ...
        <DialogPrimitive.Root>
          ...
          <DialogPrimitive.Portal>
            ...
            <DialogPrimitive.Content 
              className="fixed h-fit left-[50%] top-[50%] z-[101] w-[95vw] max-w-2xl translate-x-[-50%] translate-y-[-50%] rounded-[2rem] border border-white/10 bg-[#0B0F1A] p-8 shadow-2xl animate-in zoom-in-95 duration-200"
            >
              ...
              <div className="space-y-5">
                ...
                <div className="max-h-52 space-y-2 overflow-y-auto pr-2">
                  {devLoading ? (
                    <div className="py-10 text-center text-gray-500 animate-pulse">Searching...</div>
                  ) : filteredDevs.length === 0 ? (
                    <div className="py-10 text-center text-gray-500">
                      {search ? `No results for "${search}"` : "Search for team members"}
                    </div>
                  ) : (
