  ...
  return (
    <div className="bg-[#030712] rounded-2xl p-5 w-[420px] h-[225px]">
      <div className="flex items-start gap-4 mb-6">
        <img
          src={
            member.profilePictureUrl || "https://avatar.iran.liara.run/public"
          }
          alt={member.name}
        ...
        <div className="flex-1">
          ...
          <div className="inline-block">
            {member.tech_stack?.length ? (
              member.tech_stack.map((tech, i) => (
                <span
                  key={i}
      ...
      <div className="flex items-center justify-between gap-10 ml-auto w-full">
        ...
        <div className="flex flex-1 justify-center gap-3 max-w-sm">
          <Button
            ...
            size="primary"
            type="button"
            className="flex-1 py-2 transition-colors border-white"
          ...
          <Button
            variant="primary"
            size="primary"
            className="flex-1 py-2  hover:bg-[#8A2BE2] transition-colors"
